...
# with command line options: reco --step RAW2DIGI,RECO --conditions FT53_V21A_AN6::All --eventcontent AOD --no_exec --data --filein file:../data_HLT_RAW/hlt_data_Run2012D.root --fileout aod_data_Run2012D.root --python_filename aod_data_Run2012D.py --number -1
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:../data_HLT_RAW/hlt_data_Run2012D.root')
)
...
process.AODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('aod_data_Run2012D.root'),
