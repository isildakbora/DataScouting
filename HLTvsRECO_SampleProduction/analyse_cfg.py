...
process.source = cms.Source("PoolSource",
    ...
    #fileNames = cms.untracked.vstring('file:/cmshome/santanas/CMS/data/Run2012B_JetHT_RAW_v1_000_194_533_5483484F-E2A2-E111-A6F9-001D09F2512C.root')
)
...
process.hltReport.HLTriggerResults = cms.InputTag("TriggerResults","","HLT7E33v2")
