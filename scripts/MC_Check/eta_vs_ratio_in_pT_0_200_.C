...
//=========  (Sun Jan 25 17:35:50 2015) by ROOT version5.34/05
   ...
   gre->SetPoint(0,0.25,1.015197);
   gre->SetPointError(0,0.25,0.0002147158);
   gre->SetPoint(1,0.75,1.012283);
   gre->SetPointError(1,0.25,0.0003026765);
   gre->SetPoint(2,1.25,1.007713);
   gre->SetPointError(2,0.25,0.0003137157);
   gre->SetPoint(3,1.75,1.01297);
   gre->SetPointError(3,0.25,0.0004666809);
   gre->SetPoint(4,2.25,1.057174);
   gre->SetPointError(4,0.25,0.001046681);
