...
//=========  (Sun Jan 25 17:35:52 2015) by ROOT version5.34/05
   ...
   gre->SetPoint(0,0.25,1.007765);
   gre->SetPointError(0,0.25,0.0007189534);
   gre->SetPoint(1,0.75,1.007804);
   gre->SetPointError(1,0.25,0.001791627);
   gre->SetPoint(2,1.25,1.482197e-323);
   gre->SetPointError(2,0.25,7.410985e-323);
   gre->SetPoint(3,1.75,0);
   gre->SetPointError(3,0.25,0);
   gre->SetPoint(4,2.25,2.206363e-314);
