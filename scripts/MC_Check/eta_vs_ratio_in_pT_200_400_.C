...
//=========  (Sun Jan 25 17:35:52 2015) by ROOT version5.34/05
   TCanvas *eta_vs_ratio_in_pT_200_400 = new TCanvas("eta_vs_ratio_in_pT_200_400", "eta_vs_ratio_in_pT_200_400",180,202,600,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   ...
   gre->SetPoint(0,0.25,1.010407);
   gre->SetPointError(0,0.25,0.000394265);
   gre->SetPoint(1,0.75,1.009404);
   gre->SetPointError(1,0.25,0.000691075);
   gre->SetPoint(2,1.25,1.008985);
   gre->SetPointError(2,0.25,0.0008532284);
   gre->SetPoint(3,1.75,1.008144);
   gre->SetPointError(3,0.25,0.001067058);
   gre->SetPoint(4,2.25,0);
   gre->SetPointError(4,0.25,2.206363e-314);
