...
output_tree.Branch("Mother",Mother_v)
...
for line in input_file:
	...
	if line.split()[1] is  "2":
		Mother_ID.append(int(line.split()[0]))
        ...
        if line.split()[1] is "1":
            ...
            Mother_v.push_back( Mother_ID[int(line.split()[2])-3])
            pass
        pass
    pass
