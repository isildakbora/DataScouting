...
//=========  (Tue Jan  6 15:46:17 2015) by ROOT version5.34/05
   ...
   gre->SetPoint(1,300,0.986243);
   gre->SetPointError(1,100,0.0007552829);
   gre->SetPoint(2,500,0.9852186);
   gre->SetPointError(2,100,0.000798522);
   gre->SetPoint(3,700,0.9846281);
   gre->SetPointError(3,100,0.002013551);
   ...
   gre->SetPoint(0,100,0);
   gre->SetPointError(0,100,0);
   gre->SetPoint(1,300,0.9879913);
   gre->SetPointError(1,100,0.0004002081);
   gre->SetPoint(2,500,0.9839455);
   gre->SetPointError(2,100,0.0003727326);
   gre->SetPoint(3,700,0.9825213);
   gre->SetPointError(3,100,0.0009338037);
   gre->SetPoint(4,900,0.9819829);
   gre->SetPointError(4,100,0.002140304);
   gre->SetPoint(5,1100,0);
   gre->SetPointError(5,100,0);
   gre->SetPoint(6,1300,0);
   gre->SetPointError(6,100,0);
   ...
   gre->SetPoint(0,100,0);
   gre->SetPointError(0,100,0);
   gre->SetPoint(1,300,0.9894392);
   gre->SetPointError(1,100,0.0006576972);
   gre->SetPoint(2,500,0.9856845);
   gre->SetPointError(2,100,0.0006215147);
   gre->SetPoint(3,700,0.9828571);
   gre->SetPointError(3,100,0.001539073);
   gre->SetPoint(4,900,0);
   gre->SetPointError(4,100,0);
   gre->SetPoint(5,1100,0);
   gre->SetPointError(5,100,0);
