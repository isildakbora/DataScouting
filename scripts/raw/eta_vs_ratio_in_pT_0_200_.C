...
//=========  (Wed Jan  7 23:30:00 2015) by ROOT version5.34/05
   ...
   gre->SetPoint(0,0.25,1.005733);
   gre->SetPointError(0,0.25,0.0001093342);
   gre->SetPoint(1,0.75,0.9987455);
   gre->SetPointError(1,0.25,0.0001304494);
   gre->SetPoint(2,1.25,0.9865213);
   gre->SetPointError(2,0.25,0.0001549493);
   gre->SetPoint(3,1.75,0.9833173);
   gre->SetPointError(3,0.25,0.0001748678);
   gre->SetPoint(4,2.25,0.9692159);
   gre->SetPointError(4,0.25,0.0004281631);
