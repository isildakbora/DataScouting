...
//=========  (Tue Jan  6 15:46:18 2015) by ROOT version5.34/05
   ...
   rms_eta_1_->Range(-304.4354,-0.003910408,1598.286,0.02616965);
   ...
   graph->SetPoint(1,300,0.02242331651);
   graph->SetPoint(2,500,0.02138643725);
   ...
   Graph_Graph10->SetMaximum(0.02466565);
   ...
   graph->SetMarkerStyle(21);
   graph->SetPoint(0,100,0);
   graph->SetPoint(1,300,0.02153162852);
   graph->SetPoint(2,500,0.02331108418);
   graph->SetPoint(3,700,0);
   graph->SetPoint(4,900,0);
   graph->SetPoint(5,1100,0);
   graph->SetPoint(6,1300,0);
   ...
   Graph_Graph11->SetMaximum(0.02564219);
   ...
   graph->SetMarkerStyle(21);
   graph->SetPoint(0,100,0);
   graph->SetPoint(1,300,0.02096676289);
   graph->SetPoint(2,500,0.02086461456);
   graph->SetPoint(3,700,0);
   graph->SetPoint(4,900,0);
   graph->SetPoint(5,1100,0);
   graph->SetPoint(6,1300,0);
   ...
   Graph_Graph12->SetMaximum(0.02306344);
