{
//=========Macro generated from canvas: nPVZ_pT_1200_/nPVz_pT_1200_
//=========  (Tue Jan  6 15:46:29 2015) by ROOT version5.34/05
   TCanvas *nPVZ_pT_1200_ = new TCanvas("nPVZ_pT_1200_", "nPVz_pT_1200_",11,73,600,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   nPVZ_pT_1200_->SetHighLightColor(2);
   nPVZ_pT_1200_->Range(-0.556962,0.8682927,2.924051,1.112195);
   nPVZ_pT_1200_->SetFillColor(0);
   nPVZ_pT_1200_->SetBorderMode(0);
   nPVZ_pT_1200_->SetBorderSize(2);
   nPVZ_pT_1200_->SetTickx(1);
   nPVZ_pT_1200_->SetTicky(1);
   nPVZ_pT_1200_->SetLeftMargin(0.16);
   nPVZ_pT_1200_->SetRightMargin(0.05);
   nPVZ_pT_1200_->SetTopMargin(0.05);
   nPVZ_pT_1200_->SetBottomMargin(0.13);
   nPVZ_pT_1200_->SetFrameFillStyle(0);
   nPVZ_pT_1200_->SetFrameBorderMode(0);
   nPVZ_pT_1200_->SetFrameFillStyle(0);
   nPVZ_pT_1200_->SetFrameBorderMode(0);
   
   TGraphErrors *gre = new TGraphErrors(5);
   gre->SetName("Graph");
   gre->SetTitle("eta_vs_ratio_in_pT_1200.0_1400.0");
   gre->SetFillColor(1);
   ...
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","eta_vs_ratio_in_pT_1200.0_1400.0",100,0,2.75);
   ...
   Graph_Graph19->GetYaxis()->SetTitle("p_{T}^{HLT}/p_{T}^{RECO}");
   ...
   gre->SetMarkerStyle(21);
   gre->SetPoint(0,0.25,0.9851765);
   gre->SetPointError(0,0.25,0.002572459);
   gre->SetPoint(1,0.75,0.9834286);
   gre->SetPointError(1,0.25,0.01523537);
   ...
   TH1F *Graph_Graph20 = new TH1F("Graph_Graph20","Graph",100,0,2.75);
   ...
   Graph_Graph20->GetYaxis()->SetTitle("p_{T}^{HLT}/p_{T}^{RECO}");
   ...
   gre->SetMarkerStyle(21);
   gre->SetPoint(0,0.25,0.9853333);
   gre->SetPointError(0,0.25,0.007850454);
   gre->SetPoint(1,0.75,0.996);
   gre->SetPointError(1,0.25,0);
   gre->SetPoint(2,1.25,0);
   gre->SetPointError(2,0.25,0);
   gre->SetPoint(3,1.75,0);
   ...
   TH1F *Graph_Graph21 = new TH1F("Graph_Graph21","Graph",100,0,2.75);
   ...
   Graph_Graph21->GetYaxis()->SetTitle("p_{T}^{HLT}/p_{T}^{RECO}");
   ...
   pt->SetBorderSize(2);
   pt->SetFillColor(10);
   TText *text = pt->AddText("eta_vs_ratio_in_pT_1200.0_1400.0");
   pt->Draw();
   nPVZ_pT_1200_->Modified();
   nPVZ_pT_1200_->cd();
   nPVZ_pT_1200_->SetSelected(nPVZ_pT_1200_);
}
