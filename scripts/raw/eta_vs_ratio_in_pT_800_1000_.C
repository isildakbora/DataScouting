...
//=========  (Wed Jan  7 23:30:03 2015) by ROOT version5.34/05
   ...
   gre->SetPoint(0,0.25,0.9843955);
   gre->SetPointError(0,0.25,0.0006083424);
   gre->SetPoint(1,0.75,0.9817398);
   gre->SetPointError(1,0.25,0.0009764985);
   gre->SetPoint(2,1.25,0.9796336);
   gre->SetPointError(2,0.25,0.00198424);
   gre->SetPoint(3,1.75,2.781342e-309);
   gre->SetPointError(3,0.25,3.475153e-309);
   gre->SetPoint(4,2.25,2.275275e-314);
   gre->SetPointError(4,0.25,2.275275e-314);
