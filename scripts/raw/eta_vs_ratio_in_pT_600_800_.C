...
//=========  (Wed Jan  7 23:30:02 2015) by ROOT version5.34/05
   ...
   gre->SetPoint(0,0.25,0.9865276);
   gre->SetPointError(0,0.25,0.0002606219);
   gre->SetPoint(1,0.75,0.9822265);
   gre->SetPointError(1,0.25,0.0003747328);
   gre->SetPoint(2,1.25,0.9749036);
   gre->SetPointError(2,0.25,0.0006299203);
   gre->SetPoint(3,1.75,0.9822136);
   gre->SetPointError(3,0.25,0.001375891);
   gre->SetPoint(4,2.25,2.275275e-314);
   gre->SetPointError(4,0.25,2.255871e-314);
