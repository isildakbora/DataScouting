...
//=========  (Wed Jan  7 23:30:01 2015) by ROOT version5.34/05
   ...
   gre->SetPoint(0,0.25,0.9941972);
   gre->SetPointError(0,0.25,4.268702e-05);
   gre->SetPoint(1,0.75,0.9896801);
   gre->SetPointError(1,0.25,5.574355e-05);
   gre->SetPoint(2,1.25,0.9802676);
   gre->SetPointError(2,0.25,7.005861e-05);
   gre->SetPoint(3,1.75,0.9824471);
   gre->SetPointError(3,0.25,9.549977e-05);
   gre->SetPoint(4,2.25,0.9653779);
   gre->SetPointError(4,0.25,0.0003256401);
