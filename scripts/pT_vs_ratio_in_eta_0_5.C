...
//=========  (Wed Jan  7 23:23:54 2015) by ROOT version5.34/05
   ...
   gre->SetPoint(0,100,1.020616);
   gre->SetPointError(0,100,0.000102834);
   gre->SetPoint(1,300,1.004754);
   gre->SetPointError(1,100,4.036801e-05);
   gre->SetPoint(2,500,0.9961041);
   gre->SetPointError(2,100,7.880623e-05);
   gre->SetPoint(3,700,0.992538);
   gre->SetPointError(3,100,0.0002472511);
   gre->SetPoint(4,900,0.9896728);
   gre->SetPointError(4,100,0.0005775499);
   gre->SetPoint(5,1100,0.9887097);
   gre->SetPointError(5,100,0.001223749);
   gre->SetPoint(6,1300,1.491668e-154);
   gre->SetPointError(6,100,0);
   gre->SetPoint(7,1650,1.491668e-154);
   gre->SetPointError(7,250,0);
   gre->SetPoint(8,2150,5.928788e-323);
   gre->SetPointError(8,250,4.219107e+35);
   gre->SetPoint(9,2650,5.928788e-323);
   gre->SetPointError(9,250,6.991779e+228);
   gre->SetPoint(10,3150,2.121996e-314);
   gre->SetPointError(10,250,2.443013e+07);
   gre->SetPoint(11,3650,2.854972e+242);
   gre->SetPointError(11,250,2.854972e+242);
   gre->SetPoint(12,4150,9.569456e-315);
   gre->SetPointError(12,250,1.789145e+79);
